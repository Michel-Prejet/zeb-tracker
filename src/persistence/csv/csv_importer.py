...
def _add_run_from_tokens(tokens: list[str], fleet: Fleet) -> RunAssignment:
    """
    ...
    :return: a run assignment containing the added run and the bus it was added
    to.
    """
    ...
    fleet.add_run(run_assignment, notify=False)
